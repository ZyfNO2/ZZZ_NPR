...
<root>
  ...
  ├── Editor
  │   ├── WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package ZZZ_NPR Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.Editor.Tests.asmdef`

  `Tests/Runtime/WechatOsQy0zry6ybhrpp95c0cuwrn5va.ZzzNpr.Tests.asmdef`
...
Use the `Documentations~/ZZZ_NPR.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
